...
(X_test, y_test, g_test, _, _, _, _) = load_dataset(
    tables.WEEK, tables.METADATA, 
    length=10800, overlap=10800, class_method='macs', 
    scale = 'n', split=False
)
...
space = [
    Real(1e-12, 1e+1, name='var_smoothing', prior='log-uniform')
]
